# -*- coding: utf-8 -*-
#
# pylbd documentation build configuration file, created by
...
version = pylbd.__version__
# The full version, including alpha/beta/rc tags.
release = pylbd.__version__
...
html_logo = "./_static/pylbd-logo.png"
html_favicon = "./_static/pylbd-favicon.ico"
...
latex_documents = [
    (master_doc, 'pylbd.tex', 'pylbd Documentation',
     u'Sanhe Hu', 'manual'),
]
...
man_pages = [
    (master_doc, 'pylbd', 'pylbd Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pylbd', 'pylbd Documentation',
     author, 'pylbd', 'One line description of project.',
     'Miscellaneous'),
]
...
# Add data for Jinja2
try:
    from pylbd.docs import doc_data
except:
    doc_data = dict()
